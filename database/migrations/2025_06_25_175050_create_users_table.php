...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('users', static function (Blueprint $table) {
            ...
            $table->foreignIdFor(Community::class, 'community_id')->nullable()->constrained()->cascadeOnDelete();
            $table->foreignIdFor(Membership::class, 'membership_id')->nullable()->constrained()->cascadeOnDelete();
