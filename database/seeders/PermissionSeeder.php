...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permission::create(['name' => 'permission-pending']);
        ...
        // role permissions
        Permission::create(['name' => 'role-pending']);
        ...
        // mail permissions
        Permission::create(['name' => 'mail-pending']);
        ...
        // reply permissions
        Permission::create(['name' => 'reply-pending']);
        ...
        Permission::create(['name' => 'registrant-pending']);
        ...
        Permission::create(['name' => 'user-pending']);
        ...
        // event permissions
        Permission::create(['name' => 'event-pending']);
        ...
        // news permissions
        Permission::create(['name' => 'news-pending']);
        ...
        // post permissions
        Permission::create(['name' => 'post-pending']);
        ...
        // article permissions
        Permission::create(['name' => 'article-pending']);
        ...
        // story permissions
        Permission::create(['name' => 'story-pending']);
        ...
        // gallery permissions
        Permission::create(['name' => 'gallery-pending']);
        ...
        // album permissions
        Permission::create(['name' => 'album-pending']);
        ...
        // image permissions
        Permission::create(['name' => 'image-pending']);
        ...
        // rating permissions
        Permission::create(['name' => 'rating-pending']);
        ...
        Role::create(['name' => 'moderator'])->syncPermissions(['event-pending', 'event-create', 'event-read', 'event-update', 'event-publish', 'event-unpublish', 'event-approve', 'event-unapproved', 'event-destroy', 'post-pending', 'post-create', 'post-read',
            'post-update', 'post-publish', 'post-unpublish', 'post-approve', 'post-unapproved', 'article-pending', 'article-read', 'story-pending', 'story-create', 'story-read', 'story-update', 'story-publish', 'story-unpublish', 'story-approve', 'story-unapproved']); // moderator of posts
        Role::create(['name' => 'admin'])->syncPermissions(); // admin role
        Role::create(['name' => 'user'])->syncPermissions(['event-pending', 'event-create', 'event-read', 'event-update', 'post-pending', 'post-create', 'post-read',
            'post-update', 'article-pending', 'article-read', 'story-pending', 'story-create', 'story-read', 'story-update']); // user role
